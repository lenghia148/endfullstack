var urlSignature = (function (exports, Base64, HmacSHA1) {
	...
	var $Object$1 = Object;
	var split$3 = uncurryThis$f(''.split); // fallback for non-array-like ES3 and non-enumerable old V8 strings
	...
	var concat$2 = uncurryThis$d([].concat); // all object keys, includes non-enumerable and symbols
	...
	*/
	...
	var classof = classofRaw$2; // `IsArray` abstract operation
